...
from shape_tfds.shape.shapenet.r2n2 import ShapenetR2n2Cloud, ShapenetR2n2CloudConfig
...
def main(argv):
    builder = ShapenetR2n2Cloud(
        config=ShapenetR2n2CloudConfig(synset=FLAGS.synset, num_points=FLAGS.num_points)
    )
