...
'''
URLS = ('https://github.com/charlesq34/pointnet',
...
class Pointnet(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                num_shards=8,
                gen_kwargs=dict(base_dir=base_dir,
                                list_path=list_path.format(split='train'))),
            tfds.core.SplitGenerator(
                name=tfds.Split.TEST,
                num_shards=2,
                gen_kwargs=dict(base_dir=base_dir,
                                list_path=list_path.format(split='test')))
        ]
    ...
    def _generate_examples(self, base_dir, list_path):
        ...
        for i, data_file in enumerate(data_files):
            ...
            for j, (p, n, f,
                    l) in enumerate(zip(positions, normals, face_ids, labels)):
